...
#         if 3<idx :
#             res.append(["glyphicon glyphicon-fire", "color:#2353a5;font-size:50px;"])
#         elif ( 1.2<idx and idx<=3 ):
#             res.append(["fa-solid fa-bolt", "color:#2353a5;font-size:50px;"])
#         elif ( 0.8<idx and idx<=1.2 ):
#             res.append(["fa-solid fa-sun", "color:#2353a5;font-size:50px;"])
#         elif ( 0<idx and idx<=0.8 ):
#             res.append(["fa-solid fa-smog", "color:#2353a5;font-size:50px;"])
#         else:
#             res.append(["fa-solid fa-snowflake", "color:#2353a5;font-size:50px;"])
#     print(res)
#     return res
...
def index():
    ...
    stc_code='035420' # 삼성전자 주식코드
    yh_code='035420.KS' # 네이버 야후코드
    # ------------------

    radar_label, radar_dict, weather_list, foreign, giguan=relate_radar_weather_data(stock_code=stc_code) # TODO: 검색에서 기업 코드/이름 할당 받음
